...
if __name__ == '__main__':
    ...
    try:
        ...
        while not rospy.is_shutdown():
            ...
            agc03_LED_cmd_pub.publish("RUN1")
            rospy.sleep(1)
            ARFollower(10, 0.80, 0.1, 10)

            GoToPose(-1.80,0.10,0.0)    #GoToPose Roller AR 11
            agc03_LED_cmd_pub.publish("RUN2")
            agc03_LED_cmd_pub.publish("RUN2")
            ARFollower(11, 0.50, 0.006, 16)
            ...
            GoToPose(-1.0,1.14,-180)   #GoToPose Roller AR 10
            agc03_LED_cmd_pub.publish("RUN2")
            agc03_LED_cmd_pub.publish("RUN2")
            ...
            GoToPose(-1.80,0.60,0.0)    #GoToPose Roller AR 12
            agc03_LED_cmd_pub.publish("RUN2")
            agc03_LED_cmd_pub.publish("RUN2")
