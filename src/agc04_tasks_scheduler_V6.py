...
def agc04_load_in_10(roller_id):
    AGC04Roller("load")
    rospy.sleep(1)
    Roller(10, "unload")
    #rospy.sleep(15)
    ...
    while not ( rospy.is_shutdown() or flag ):
        ...
        rospy.loginfo("--------------------------------------------------")
        #if ((status_of_roller10 == "roller10_complete_unload")or(status_of_roller10 == "roller10_complete_load")) and (status_of_agc04_roller == "complete_load"):
...
def agc04_load_out_10(roller_id):
    Roller(10, "load")
    rospy.sleep(1)
    AGC04Roller("unload")
    #rospy.sleep(15)
    ...
    while not ( rospy.is_shutdown() or flag ):
        ...
        rospy.loginfo("Roller10 status     : %s " % status_of_roller10)
        rospy.loginfo("----------------------------------------------------")
        #if (status_of_roller10 == "roller10_complete_load") and (status_of_agc04_roller == "complete_unload"):
...
def agc04_load_in_11(roller_id):
    AGC04Roller("load")
    rospy.sleep(1)
    Roller(11, "unload")
    #rospy.sleep(15)
    ...
    while not ( rospy.is_shutdown() or flag ):
        ...
        rospy.loginfo("--------------------------------------------------")
        #if ((status_of_roller11 == "roller10_complete_unload")or(status_of_roller11 == "roller11_complete_load")) and (status_of_agc04_roller == "complete_load"):
        if (status_of_agc04_roller == "complete_load"):
            rospy.loginfo("AGC04-Loading is Done.")
            rospy.sleep(1)
            flag = True
...
def agc04_load_out_11(roller_id):
    Roller(11, "load")
    rospy.sleep(1)
    AGC04Roller("unload")
    #rospy.sleep(15)
    ...
    while not ( rospy.is_shutdown() or flag ):
        ...
        rospy.loginfo("Roller11 status     : %s " % status_of_roller11)
        rospy.loginfo("----------------------------------------------------")
        #if (status_of_roller11 == "roller11_complete_load") and (status_of_agc04_roller == "complete_unload"):
        if (status_of_agc04_roller == "complete_unload"):
            rospy.loginfo("Done Un-Loading.")
            rospy.sleep(1)
            flag = True
...
def agc04_load_in_12(roller_id):
    AGC04Roller("load")
    rospy.sleep(1)
    Roller(12, "unload")
    #rospy.sleep(15)
    ...
    while not ( rospy.is_shutdown() or flag ):
        ...
        rospy.loginfo("--------------------------------------------------")
        #if ((status_of_roller12 == "roller12_complete_unload")or(status_of_roller12 == "roller12_complete_load")) and (status_of_agc04_roller == "complete_load"):
        if (status_of_agc04_roller == "complete_load"):
            rospy.loginfo("AGC04-Loading is Done.")
            rospy.sleep(1)
            flag = True
...
def agc04_load_out_12(roller_id):
    Roller(12, "load")
    rospy.sleep(1)
    AGC04Roller("unload")
    #rospy.sleep(15)
    ...
    while not ( rospy.is_shutdown() or flag ):
        ...
        rospy.loginfo("Roller12 status     : %s " % status_of_roller12)
        rospy.loginfo("----------------------------------------------------")
        #if (status_of_roller12 == "roller12_complete_load") and (status_of_agc04_roller == "complete_unload"):
        if (status_of_agc04_roller == "complete_unload"):
            rospy.loginfo("Done Un-Loading.")
            rospy.sleep(1)
            flag = True
...
if __name__ == '__main__':
    ...
    try:
        ...
        while not rospy.is_shutdown():
            ...
            GoToPose(0.89,3.2,-90)    #GoToPose Roller AR 11
            ...
            GoToPose(1.40,2.5,90)   #GoToPose Roller AR 10
            agc04_LED_cmd_pub.publish("RUN2")
            agc04_LED_cmd_pub.publish("RUN2")
            ...
            GoToPose(1.4,3.2,-90)    #GoToPose Roller AR 12
            agc04_LED_cmd_pub.publish("RUN2")
            agc04_LED_cmd_pub.publish("RUN2")
