...
if __name__ == '__main__':
    ...
    try:
        ...
        while not rospy.is_shutdown():
            ...
            agc04_LED_cmd_pub.publish("RUN1")
            rospy.sleep(1)
            ARFollower(13, 0.85, 0.1, 10)

            GoToPose(-0.1,3.2,-90)    #GoToPose Roller AR 14
            agc04_LED_cmd_pub.publish("RUN2")
            agc04_LED_cmd_pub.publish("RUN2")
            ARFollower(14, 0.5, 0.006, 16)
            ...
            GoToPose(0.85,2.5,90)   #GoToPose Roller AR 13
            agc04_LED_cmd_pub.publish("RUN2")
            agc04_LED_cmd_pub.publish("RUN2")
            ...
            GoToPose(0.38,3.2,-90)    #GoToPose Roller AR 15
            agc04_LED_cmd_pub.publish("RUN2")
            agc04_LED_cmd_pub.publish("RUN2")
